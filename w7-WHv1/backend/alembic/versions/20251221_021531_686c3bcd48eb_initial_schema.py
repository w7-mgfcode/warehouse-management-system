...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint("role IN ('admin', 'manager', 'warehouse', 'viewer')", name='check_user_role'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.CheckConstraint("status IN ('empty', 'occupied', 'reserved', 'inactive')", name='check_bin_status'),
    sa.ForeignKeyConstraint(['warehouse_id'], ['warehouses.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('code')
    )
    op.create_table('bin_contents',
    sa.Column('id', UUID(as_uuid=True), nullable=False),
    sa.Column('bin_id', UUID(as_uuid=True), nullable=False),
    ...
    sa.CheckConstraint('use_by_date >= best_before_date OR best_before_date IS NULL', name='check_use_by_after_best_before'),
